        ...
        <div className="max-w-2xl mx-auto mt-10">
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-80">
                        ...
                        <textarea
                            ...
                            className="w-full p-3 border text-gray-800 rounded mb-4 resize-none overflow-hidden h-12"
                        />
            ...
            <div className="mt-4 flex items-center">
                <textarea
                    ...
                    className="flex-grow resize-none text-gray-800 overflow-hidden h-12 p-3 rounded-l-lg border border-gray-300 focus:outline-none focus:ring focus:border-blue-300"
                    rows="2"
                />
                <button
