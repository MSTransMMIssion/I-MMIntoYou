        ...
        <div className="max-w-2xl mx-auto mt-10">
            ...
            <div className="mt-4 flex items-center">
                <textarea
                    ...
                    className="flex-grow resize-none overflow-hidden text-gray-700 h-12 p-3 rounded-l-lg border border-gray-300 focus:outline-none focus:ring focus:border-blue-300"
                    rows="2"
                />
                <button
